...
class PendingRequest {
    ...
    withButtonLoading(element) {
        this.beforeSend(() => Apps.showButtonLoading(element))
        this.completed(() => Apps.hideButtonLoading(element))

        return this
    }

    withLoading(element) {
        this.beforeSend(() => Apps.showLoading(element))
        this.completed(() => Apps.hideLoading(element))
    ...
    withDefaultErrorHandler() {
        this.errorHandlerUsing((error) => {
            ...
            switch (statusCode) {
                case 419:
                    Apps.showError('Session expired this page will reload in 5s.')
