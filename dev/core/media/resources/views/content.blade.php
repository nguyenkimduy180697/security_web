        ...
        <div class="app-media-main-wrapper">
            <x-core::card.header class="flex-column app-media-header p-0">
                ...
                <div class="row w-100 p-2">
                    <div class="col p-2 d-flex align-items-center app-media-breadcrumb">
                        <ul class="breadcrumb"></ul>
                    </div>
                    <div class="col-md-auto d-flex justify-content-between justify-content-md-end align-items-center app-media-tools">
                        <div
                            class="btn-list"
                            role="group"
                        >
