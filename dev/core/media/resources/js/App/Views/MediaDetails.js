...
export class MediaDetails {
    constructor() {
        this.$detailsWrapper = $('.app-media-main .app-media-details')

        this.descriptionItemTemplate = `<div class="mb-3 app-media-name">
    ...
    renderData(data) {
        ...
        _self.$detailsWrapper.find('.app-media-thumbnail').html(thumb)
        _self.$detailsWrapper.find('.app-media-thumbnail').css('color', data.color)
        _self.$detailsWrapper.find('.app-media-description').html(description)
        ...
        if (data.mime_type && data.mime_type.indexOf('image') !== -1) {
            ...
            image.onload = () => {
                ...
                _self.$detailsWrapper.find('.app-media-description').append(dimensions)
            }
        }
    }
}
