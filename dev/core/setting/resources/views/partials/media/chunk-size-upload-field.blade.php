<x-core-setting::form-group>
    <x-core::form.on-off.checkbox
        ...
        :checked="AppMedia::isChunkUploadEnabled()"
    ...
    <x-core::form.fieldset
        data-bb-value="1"
        class="chunk-size"
        @style(['display: none;' => !AppMedia::isChunkUploadEnabled()])
    >
        <div class="row">
            <div class="col-lg-6">
                <x-core::form.text-input
                    ...
                    type="number"
                    :value="setting('media_chunk_size', AppMedia::getConfig('chunk.chunk_size'))"
            ...
            <div class="col-lg-6">
                <x-core::form.text-input
                    ...
                    type="number"
                    :value="setting('media_max_file_size', AppMedia::getConfig('chunk.max_file_size'))"
