...
@if ($canChangeProfile)
    @push('footer')
        {!! JsValidator::formRequest(Dev\ACL\Http\Requests\UpdateProfileRequest::class, '#profile-form') !!}
        {!! JsValidator::formRequest(Dev\ACL\Http\Requests\UpdatePasswordRequest::class, '#password-form') !!}
    @endpush
@endif
