...
use Dev\PluginManagement\Enums\PluginFilterStatus;
...
class PluginManagementController extends BaseController
{
    ...
    protected function breadcrumb(): Breadcrumb
    {
        return parent::breadcrumb()
            ...
            ->add(trans('libs/plugin-management::plugin.installed_plugins'), route('plugins.index'));
    }

    public function index(): View
    {
        $this->pageTitle(trans('libs/plugin-management::plugin.installed_plugins'));

        Assets::addScriptsDirectly('vendor/core/libs/plugin-management/js/plugin.js');
        ...
        return view('libs/plugin-management::index', compact('plugins', 'filterStatuses'));
    }
    ...
    public function update(Request $request): BaseHttpResponse
    {
        ...
        if (! $this->pluginService->validatePlugin($plugin)) {
            return $this
                ->httpResponse()
                ->setError()
                ->setMessage(trans('libs/plugin-management::plugin.invalid_plugin'));
        }
        ...
        try {
            ...
            return $this
                ...
                ->setMessage(trans('libs/plugin-management::plugin.update_plugin_status_success'));
    ...
    public function destroy(string $plugin): BaseHttpResponse
    {
        try {
            ...
            return $this
                ->httpResponse()
                ->setMessage(trans('libs/plugin-management::plugin.remove_plugin_success'));
        } catch (Exception $exception) {
            return $this
                ->httpResponse()
                ->setError()
        ...
        if (! empty($requiredPlugins)) {
            ...
            if (empty($existingPluginsOnMarketplace)) {
                return $this
                    ->httpResponse()
                    ->setError()
                    ->setMessage(trans('libs/plugin-management::plugin.missing_required_plugins', [
            ...
            return $this
                ...
                ->setMessage(__('libs/plugin-management::plugin.requirement_not_met', [
