...
class MarketplaceService
{
    ...
    {
        abort_unless(config('libs.plugin-management.general.enable_marketplace_feature'), 404);
        ...
        if ($response->failed()) {
            throw new Exception($response->json('message') ?: trans('libs/plugin-management::marketplace.could_not_connect'));
        }
