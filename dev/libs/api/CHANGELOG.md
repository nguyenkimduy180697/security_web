...
All notable changes to `dev/git-commit-checker` will be documented in this file.
...
- Fix output render on Windows platform (https://github.com/vswb/git-commit-checker/pull/10)
