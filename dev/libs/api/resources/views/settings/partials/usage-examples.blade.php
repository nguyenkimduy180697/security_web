...
<div class="mt-3">
    <h6>{{ trans('libs/api::api.api_usage_examples') }}</h6>

    <div class="mb-3 api-code-example">
        <label class="form-label">{{ trans('libs/api::api.api_usage_curl_example') }}</label>
    ...
    <div class="mb-3 api-code-example">
        <label class="form-label">{{ trans('libs/api::api.api_usage_javascript_example') }}</label>
        <div class="position-relative">
