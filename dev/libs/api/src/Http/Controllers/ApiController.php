...
use Dev\Api\Http\Requests\SendNotificationRequest;
use Dev\Api\Services\PushNotificationService;
...
class ApiController extends SettingController
{
    public function edit(SanctumTokenTable $sanctumTokenTable)
    {
        ...
        Assets::addScriptsDirectly('vendor/core/libs/api/js/api-settings.js')
            ->addStylesDirectly('vendor/core/libs/api/css/api-settings.css');
        ...
        $translations = [
            'api_key_generated' => trans('libs/api::api.api_key_generated'),
            'api_key_copied' => trans('libs/api::api.api_key_copied'),
            'api_key_edit_enabled' => trans('libs/api::api.api_key_edit_enabled'),
            'notification_sending' => trans('libs/api::api.notification_sending'),
            'notification_sent_success' => trans('libs/api::api.notification_sent_success'),
            'notification_sent_error' => trans('libs/api::api.notification_sent_error'),
            'file_uploaded_successfully' => trans('libs/api::api.file_uploaded_successfully'),
            'file_removed_successfully' => trans('libs/api::api.file_removed_successfully'),
            'invalid_json_file' => trans('libs/api::api.invalid_json_file'),
            'file_upload_error' => trans('libs/api::api.file_upload_error'),
            'file_remove_error' => trans('libs/api::api.file_remove_error'),
            'send_notification' => trans('libs/api::api.send_notification'),
            'your_api_key_here' => trans('libs/api::api.your_api_key_here'),
            'file_size_too_large' => trans('libs/api::api.file_size_too_large'),
            'confirm_remove_service_account' => trans('libs/api::api.confirm_remove_service_account'),
            'service_account_file_label' => trans('libs/api::api.service_account_file_label'),
            'just_uploaded' => trans('libs/api::api.just_uploaded'),
            'service_account_not_uploaded' => trans('libs/api::api.service_account_not_uploaded'),
            'please_enter_notification_title' => trans('libs/api::api.please_enter_notification_title'),
            'please_enter_notification_message' => trans('libs/api::api.please_enter_notification_message'),
            'notification_error_occurred' => trans('libs/api::api.notification_error_occurred'),
            'sent_to_devices' => trans('libs/api::api.sent_to_devices'),
            'failed_devices' => trans('libs/api::api.failed_devices'),
            'will_send_to_devices' => trans('libs/api::api.will_send_to_devices'),
            'close' => trans('libs/api::api.close'),
        ];

        return view('libs/api::settings', compact('form', 'sanctumTokenTable', 'translations'));
    }
