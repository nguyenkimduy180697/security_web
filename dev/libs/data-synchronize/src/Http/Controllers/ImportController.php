...
abstract class ImportController extends BaseController
{
    ...
    public function validateData(ImportRequest $request)
    {
        try {
            ...
            $message = $response->getFromOffset() <= $response->getNextOffset() ? trans('libs/data-synchronize::data-synchronize.import.validating_message', [
        ...
        try {
            ...
            if ($from <= $to) {
                ...
                if ($total > 0) {
                    ...
                    $message = trans('libs/data-synchronize::data-synchronize.import.no_data_message', [
