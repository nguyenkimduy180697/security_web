...
class ClearChunksCommand extends Command
{
    ...
    {
        $storageDisk = Storage::disk(config('libs.data-synchronize.data-synchronize.storage.disk'));

        $storagePath = config('libs.data-synchronize.data-synchronize.storage.path');
