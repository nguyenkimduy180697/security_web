...
abstract class Exporter implements FromCollection, ShouldAutoSize, WithColumnFormatting, WithEvents, WithHeadings, WithMapping
{
    ...
    {
        $view = 'libs/data-synchronize::export';
    ...
    {
        if ($memoryLimit = config('libs.data-synchronize.export.memory_limit')) {
            ini_set('memory_limit', $memoryLimit);
        }

        if ($timeLimit = config('libs.data-synchronize.export.time_limit')) {
