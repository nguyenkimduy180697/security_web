...
@section(
    'pageTitle',
     trans(
         ...
         ['step' => 4, 'title' => trans('libs/installer::installer.theme_preset.title')]
     )
)
...
@section('header')
    <div>
        <x-core::card.title class="text-start">
            {{ trans('libs/installer::installer.theme_preset.title') }}
        </x-core::card.title>

        <x-core::card.subtitle>
            {{ trans('libs/installer::installer.theme_preset.message') }}
        </x-core::card.subtitle>
    </div>
@endsection
...
@section('footer')
    <x-core::button type="submit" color="primary" form="choose-theme-form">
        {{ trans('libs/installer::installer.next') }}
    </x-core::button>
@endsection
