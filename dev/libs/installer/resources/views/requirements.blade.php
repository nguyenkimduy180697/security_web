...
@section(
    'pageTitle',
     trans(
         ...
         ['step' => 2, 'title' => trans('libs/installer::installer.requirements.title')]
     )
)

@section('header')
    <x-core::card.title>
        {{ trans('libs/installer::installer.requirements.title') }}
    </x-core::card.title>
@endsection
...
@section('footer')
    ...
    >
        {{ trans('libs/installer::installer.permissions.next') }}
    </x-core::button>
@endsection
