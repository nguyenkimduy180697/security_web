...
<x-core::modal
    :title="trans('libs/shortcode::shortcode.ui-blocks')"
...
>
    <x-core::form.text-input
        type="search"
        name="search"
        :placeholder="trans('libs/shortcode::shortcode.search')"
        :group-flat="true"
    >
        <x-slot:prepend>
                    ...
                    <div class="shortcode-item">
                        <x-core::card>
                            <div class="image-wrapper w-100 position-relative overflow-hidden">
                                <img src="{{ $image = Arr::get($shortcode, 'previewImage') ?: asset('vendor/core/libs/shortcode/images/placeholder-code.jpg') }}" alt="{{ $shortcode['name'] }}"/>
                            </div>
                                    ...
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-3 text-end">
                                            <x-core::button size="xs" class="use-button" data-bb-toggle="shortcode-button-use">
                                                {{ trans('libs/shortcode::shortcode.use') }}
                                            </x-core::button>
                                        </div>
                                    </div>
                                </div>
    ...
    <x-core::empty-state
        :title="trans('libs/shortcode::shortcode.no_shortcode_found')"
        style="display: none;"
