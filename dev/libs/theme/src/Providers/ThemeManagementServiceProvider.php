...
class ThemeManagementServiceProvider extends ServiceProvider
{
    ...
    protected function loadJsonTranslationsFromTheme(string $theme): void
    {
        ...
        $this->loadJsonTranslationsFrom(lang_path('vendor/ui/' . $theme));
    }
    ...
    {
        if (! class_exists('Dev\Widget\Providers\WidgetServiceProvider')) {
            return;
        }
        ...
        add_filter(THEME_FRONT_HEADER, function ($html) {
            ...
            return $html . Html::style('vendor/core/libs/theme/css/guideline.css');
        }, 16);
    }
