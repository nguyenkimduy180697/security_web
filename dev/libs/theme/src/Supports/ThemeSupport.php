...
class ThemeSupport
{
    public static function registerYoutubeShortcode(?string $viewPath = null): void
    {
        ...
        shortcode()
            ->register(
                'youtube-video',
                trans('libs/theme::theme.shortcodes.youtube_video'),
                trans('libs/theme::theme.shortcodes.add_youtube_video'),
            ...
            ->setAdminConfig('youtube-video', function ($attributes, $content) {
                return ShortcodeForm::createFromArray($attributes)
                    ->add('url', TextField::class, [
                        'label' => trans('libs/theme::theme.shortcodes.youtube_url'),
                        'attr' => [
                    ...
                    ->add('width', NumberField::class, [
                        'label' => trans('libs/theme::theme.common.width'),
                    ])
                    ->add('height', NumberField::class, [
                        'label' => trans('libs/theme::theme.common.height'),
                    ]);
            });
    }
    ...
    public static function registerGoogleMapsShortcode(?string $viewPath = null): void
    {
        ...
        shortcode()
            ->register(
                'google-map',
                trans('libs/theme::theme.shortcodes.google_maps'),
                trans('libs/theme::theme.shortcodes.add_google_maps_iframe'),
            ...
            ->setAdminConfig('google-map', function (array $attributes, ?string $content) {
                return ShortcodeForm::createFromArray($attributes)
                    ->add('address', 'textarea', [
                        'label' => trans('libs/theme::theme.common.address'),
                        'attr' => [
                            'data-shortcode-attribute' => 'content',
        ...
        app('events')->listen(RenderingThemeOptionSettings::class, function (): void {
            theme_option()
                ->setField([
                    ...
                    'type' => 'customSelect',
                    'label' => trans('libs/theme::theme.preloader.enable'),
                    'attributes' => [
                        'name' => 'preloader_enabled',
                        'list' => [
                            'yes' => trans('libs/theme::theme.common.yes'),
                            'no' => trans('libs/theme::theme.common.no'),
                        ],
                        'value' => 'no',
                        'options' => [
                            'class' => 'form-control',
                ...
                ->when(count(static::getPreloaderVersions()) > 1, function () {
                    return theme_option()
                        ->setField([
                            ...
                            'section_id' => 'opt-text-subsection-general',
                            'type' => 'customSelect',
                            'label' => trans('libs/theme::theme.preloader.version'),
                            'attributes' => [
    ...
    public static function getPreloaderVersions(): array
    {
        return apply_filters('theme_preloader_versions', [
            'v1' => trans('libs/theme::theme.common.default'),
        ]);
    }
    ...
    public static function registerFacebookIntegration(): void
    {
        app('events')->listen(RenderingThemeOptionSettings::class, function (): void {
            theme_option()
                ->setSection([
                    'title' => trans('libs/theme::theme.facebook.integration'),
                    ...
                    'fields' => [
                        [
                            'id' => 'facebook_page_id',
                            'type' => 'text',
                            'label' => trans('libs/theme::theme.facebook.page_id'),
                            'helper' => trans(
                                'libs/theme::theme.facebook.page_id_helper',
                        ...
                        [
                            ...
                            'type' => 'customSelect',
                            'label' => trans('libs/theme::theme.facebook.enable_comment'),
                            'attributes' => [
                        ...
                        [
                            'id' => 'facebook_app_id',
                            'type' => 'text',
                            'label' => trans('libs/theme::theme.facebook.app_id'),
                            'attributes' => [
                            ...
                            'helper' => trans(
                                'libs/theme::theme.facebook.app_id_helper',
                        ...
                        [
                            'id' => 'facebook_admins',
                            'type' => 'repeater',
                            'label' => trans('libs/theme::theme.facebook.admins'),
                            'attributes' => [
                                ...
                                'fields' => [
                                    [
                                        'type' => 'text',
                                        'label' => trans('libs/theme::theme.facebook.admin_id'),
                                        'attributes' => [
                                            'name' => 'text',
                                            'value' => null,
                                            'options' => [
                            ...
                            'helper' => trans(
                                'libs/theme::theme.facebook.admins_helper',
        ...
        app('events')->listen(RenderingThemeOptionSettings::class, function (): void {
            ThemeOption::setSection(
                ThemeOptionSection::make('opt-text-subsection-social-links')
                    ->title(trans('libs/theme::theme.social_links.title'))
                    ->icon('ti ti-social')
                    ->fields([
                        [
                            'id' => 'social_links',
                            'type' => 'repeater',
                            'label' => trans('libs/theme::theme.social_links.title'),
                            'attributes' => [
                                'name' => 'social_links',
                                'value' => null,
    ...
    public static function getSocialLinksRepeaterFields(): array
    {
        return [
            [
                'type' => 'text',
                'label' => trans('libs/theme::theme.common.name'),
                'attributes' => [
                    'name' => 'name',
                    'value' => null,
                    'options' => [
            ...
            [
                'type' => 'coreIcon',
                'label' => trans('libs/theme::theme.common.icon'),
                'attributes' => [
                    'name' => 'icon',
                    'value' => null,
                    'options' => [
            ...
            [
                'type' => 'text',
                'label' => trans('libs/theme::theme.common.url'),
                'attributes' => [
                    'name' => 'url',
                    'value' => null,
                    'options' => [
            ...
            [
                'type' => 'mediaImage',
                'label' => trans('libs/theme::theme.social_links.icon_image_override'),
                'attributes' => [
                    'name' => 'image',
                    'value' => null,
                ],
            ...
            [
                'type' => 'customColor',
                'label' => trans('libs/theme::theme.common.color'),
                'attributes' => [
                    'name' => 'color',
                    'value' => 'transparent',
                    'options' => [
            ...
            [
                'type' => 'customColor',
                'label' => trans('libs/theme::theme.common.background_color'),
                'attributes' => [
    ...
    public static function registerSiteCopyright(): void
    {
        app('events')->listen(RenderingThemeOptionSettings::class, function (): void {
            ThemeOption::setField([
                ...
                'section_id' => 'opt-text-subsection-general',
                'type' => 'textarea',
                'label' => trans('libs/theme::theme.copyright.label'),
                'attributes' => [
                    'name' => 'copyright',
                    'value' => null,
                    'options' => [
                        'class' => 'form-control',
                        'placeholder' => trans('libs/theme::theme.copyright.placeholder'),
                        'data-counter' => 255,
                        'rows' => 3,
                    ],
                ],
                'helper' => trans('libs/theme::theme.copyright.helper'),
            ]);
        });
    }
    ...
    public static function registerLazyLoadImages(): void
    {
        app('events')->listen(RenderingThemeOptionSettings::class, function (): void {
            ThemeOption::setField([
                ...
                'section_id' => 'opt-text-subsection-general',
                'type' => 'onOff',
                'label' => trans('libs/theme::theme.lazy_load.label'),
                'attributes' => [
                    'name' => 'lazy_load_images',
                    'value' => false,
                ],
                'helper' => trans('libs/theme::theme.lazy_load_images_helper'),
            ])->setField([
                'id' => 'lazy_load_placeholder_image',
                'section_id' => 'opt-text-subsection-general',
                'type' => 'mediaImage',
                'label' => trans('libs/theme::theme.lazy_load.placeholder_image'),
                'attributes' => [
                    'name' => 'lazy_load_placeholder_image',
                    'value' => null,
                ],
                'helper' => trans('libs/theme::theme.lazy_load.placeholder_image_helper'),
            ]);
        });
        ...
        Theme::asset()
            ->container('footer')
            ->add('lazyload', asset('vendor/core/libs/theme/plugins/lazyload.min.js'), ['jquery'], ['defer'], version: get_cms_version());
        ...
        app('events')->listen(RenderingThemeOptionSettings::class, function (): void {
            ThemeOption::setSection(
                ThemeOptionSection::make('opt-text-subsection-social-sharing')
                    ->title(trans('libs/theme::theme.social_sharing.title'))
                    ->icon('ti ti-share')
                    ->fields([
                        RepeaterField::make()
                            ->name('social_sharing')
                            ->label(trans('libs/theme::theme.social_sharing.buttons'))
                            ->defaultValue(self::getDefaultSocialSharingData())
                            ->fields([
                                SelectField::make()
                                    ->name('social')
                                    ->label(trans('libs/theme::theme.social_sharing.social'))
                                    ->options([
                                        'facebook' => trans('libs/theme::theme.social_sharing.facebook'),
                                        'x' => trans('libs/theme::theme.social_sharing.x_twitter'),
                                        'linkedin' => trans('libs/theme::theme.social_sharing.linkedin'),
                                        'pinterest' => trans('libs/theme::theme.social_sharing.pinterest'),
                                        'whatsapp' => trans('libs/theme::theme.social_sharing.whatsapp'),
                                        'telegram' => trans('libs/theme::theme.social_sharing.telegram'),
                                        'email' => trans('libs/theme::theme.social_sharing.email'),
                                    ]),
                                IconField::make()
                                    ->name('icon')
                                    ->label(trans('libs/theme::theme.common.icon')),
                                MediaImageField::make()
                                    ->name('icon_image')
                                    ->label(trans('libs/theme::theme.social_sharing.icon_image_override')),
                                ColorField::make()
                                    ->name('color')
                                    ->label(trans('libs/theme::theme.common.color')),
                                ColorField::make()
        ...
        foreach ($socialSharing as $item) {
            ...
            $items[$social] = [
                'name' => $name = match ($social) {
                    ...
                    'telegram' => trans('libs/theme::theme.social_sharing.telegram'),
                    'email' => trans('libs/theme::theme.social_sharing.email'),
                    default => trans('libs/theme::theme.common.unknown'),
                },
    ...
    public static function supportedDateFormats(): array
    {
        ...
        if ($extraDateFormat = config('libs.theme.general.extra_date_format')) {
        ...
        app('events')->listen(RenderingThemeOptionSettings::class, function (): void {
            ThemeOption::setField(
                SelectField::make()
                    ...
                    ->label(trans('libs/theme::theme.date_format.label'))
                    ->name('date_format')
                    ...
                    ->helperText(trans('libs/theme::theme.date_format.helper'))
            );
        });
        ...
        app('events')->listen(RenderingThemeOptionSettings::class, function () use ($defaultValue): void {
            ThemeOption::setField(
                NumberFieldOption::make()
                    ...
                    ->name('logo_height')
                    ->label(trans('libs/theme::theme.logo_height.label'))
                    ->helperText(trans('libs/theme::theme.logo_height.helper', ['default' => $defaultValue . 'px']))
                    ->attributes([
                        'min' => 0,
                        'max' => 150,
                    ])
