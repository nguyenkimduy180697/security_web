                ...
                <x-core::card>
                    @if ($inherit = Arr::get($theme, 'inherit'))
                        <div class="ribbon bg-red">
                            {{ trans('libs/theme::theme.child_of', ['theme' => Arr::get($themes, $inherit . '.name', $inherit)]) }}
                        </div>
                    @endif
                        ...
                        <div class="row g-1 g-lg-0">
                            ...
                            @if (! empty($theme['version']))
                                <div class="col-12 col-lg-auto">
                                    {{ trans('libs/theme::theme.version') }}:
                        ...
                        <div class="btn-list">
                            @if (setting('theme') && Theme::getThemeName() == $key)
                                <x-core::button
                                    ...
                                    icon="ti ti-check"
                                >
                                    {{ trans('libs/theme::theme.activated') }}
                                </x-core::button>
                            @else
...
@push('footer')
    <x-core::modal.action
        ...
        type="danger"
        :title="trans('libs/theme::theme.remove_theme')"
        :description="trans('libs/theme::theme.remove_theme_confirm_message')"
        :submit-button-attrs="['id' => 'confirm-remove-theme-button']"
        :submit-button-label="trans('libs/theme::theme.remove_theme_confirm_yes')"
    />
@endpush
