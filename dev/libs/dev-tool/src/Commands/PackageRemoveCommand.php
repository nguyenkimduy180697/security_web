...
use Dev\DevTool\Helper as HelperDevTool;
...
#[AsCommand('cms:package:remove', 'Remove a package in the /dev/libs directory.')]
class PackageRemoveCommand extends Command implements PromptsForMissingInput
{
    ...
    protected function processRemove(string $package, string $location): bool
    {
        ...
        $this->components->info(sprintf('Remove <comment>"dev/%s": "*@dev"</comment> to composer.json then run <comment>composer update</comment> to remove this package!', $package));
