@php
    $service = app(\Dev\Sitemap\Services\IndexNowService::class);
...
@if (!$apiKey)
    <div class="alert alert-warning d-flex align-items-start mb-3">
        ...
        <div class="flex-grow-1">
            <strong>{{ trans('libs/sitemap::sitemap.settings.indexnow_no_key') }}</strong>
            <p class="mb-2 mt-1">{{ trans('libs/sitemap::sitemap.settings.indexnow_no_key_help') }}</p>
            <div class="d-flex flex-wrap gap-2 align-items-center">
                <button type="button" class="btn btn-sm btn-warning" onclick="generateIndexNowKey()">
                    ...
                    {{ trans('libs/sitemap::sitemap.settings.generate_api_key') }}
                </button>
                <small class="text-muted">
                    <x-core::icon name="ti ti-info-circle" class="me-1" />
                    {{ trans('libs/sitemap::sitemap.settings.generate_key_command') }}
...
@else
    ...
    @if ($keyFileExists && $keyFileValid)
        <div class="alert alert-success d-flex align-items-start mb-3">
            ...
            <div class="flex-grow-1">
                <strong>{{ trans('libs/sitemap::sitemap.settings.indexnow_ready') }}</strong>
                <p class="mb-2 mt-1">{{ trans('libs/sitemap::sitemap.settings.indexnow_ready_help') }}</p>
    @elseif ($keyFileExists && !$keyFileValid)
        <div class="alert alert-warning d-flex align-items-start mb-3">
            <x-core::icon name="ti ti-alert-triangle" class="me-2 mt-1 flex-shrink-0" />
            <div class="flex-grow-1">
                <strong>{{ trans('libs/sitemap::sitemap.settings.key_file_invalid') }}</strong>
                <p class="mb-2 mt-1">{{ trans('libs/sitemap::sitemap.settings.key_file_invalid_help') }}</p>
    @else
        <div class="alert alert-warning d-flex align-items-start mb-3">
            <x-core::icon name="ti ti-alert-triangle" class="me-2 mt-1 flex-shrink-0" />
            <div class="flex-grow-1">
                <strong>{{ trans('libs/sitemap::sitemap.settings.key_file_missing') }}</strong>
                <p class="mb-2 mt-1">{{ trans('libs/sitemap::sitemap.settings.key_file_missing_help') }}</p>
    @endif

            <div class="row g-2">
                <div class="col-md-6">
                    <label class="form-label small text-muted">{{ trans('libs/sitemap::sitemap.settings.key_file_name') }}</label>
                ...
                <div class="col-md-6">
                    <label class="form-label small text-muted">{{ trans('libs/sitemap::sitemap.settings.key_file_content') }}</label>
                    <div class="input-group input-group-sm">
            ...
            <div class="mt-3 d-flex flex-wrap gap-2">
                ...
                <button type="button" class="btn btn-sm btn-outline-warning" onclick="regenerateIndexNowKey()">
                    ...
                    {{ trans('libs/sitemap::sitemap.settings.regenerate_api_key') }}
                </button>
                ...
                <button type="button" class="btn btn-sm btn-outline-info" onclick="showIndexNowInstructions()">
                    ...
                    {{ trans('libs/sitemap::sitemap.settings.setup_instructions') }}
                </button>
            </div>
        </div>
    </div>
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-header bg-light border-bottom">
                <h6 class="mb-0 d-flex align-items-center">
                    ...
                    {{ trans('libs/sitemap::sitemap.settings.indexnow_info') }}
                </h6>
            </div>
            <div class="card-body">
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <h6 class="mb-1 text-success">{{ trans('libs/sitemap::sitemap.settings.automatic_setup') }}</h6>
                            <small class="text-muted">{{ trans('libs/sitemap::sitemap.settings.automatic_setup_desc') }}</small>
                        </div>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <div class="fw-medium mb-1">{{ trans('libs/sitemap::sitemap.settings.step_generate') }}</div>
                                    <small class="text-muted">{{ trans('libs/sitemap::sitemap.settings.auto_step_1') }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <div class="fw-medium mb-1">{{ trans('libs/sitemap::sitemap.settings.step_create_file') }}</div>
                                    <small class="text-muted">{{ trans('libs/sitemap::sitemap.settings.auto_step_2', ['filename' => $keyFileName]) }}</small>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    <div class="fw-medium mb-1">{{ trans('libs/sitemap::sitemap.settings.step_ready') }}</div>
                                    <small class="text-muted">{{ trans('libs/sitemap::sitemap.settings.auto_step_3', ['url' => $keyFileUrl]) }}</small>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <h6 class="mb-1 text-info">{{ trans('libs/sitemap::sitemap.settings.supported_engines') }}</h6>
                            <small class="text-muted">{{ trans('libs/sitemap::sitemap.settings.supported_engines_desc') }}</small>
                        </div>
                    </div>
                ...
                <div class="mb-4">
                    <div class="d-flex align-items-center mb-3">
                        ...
                        <div>
                            <h6 class="mb-1 text-warning">{{ trans('libs/sitemap::sitemap.settings.indexnow_benefits') }}</h6>
                            <small class="text-muted">{{ trans('libs/sitemap::sitemap.settings.indexnow_benefits_desc') }}</small>
                        </div>
                    </div>
                    ...
                    <div class="row g-2">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                ...
                                <small>{{ trans('libs/sitemap::sitemap.settings.benefit_instant') }}</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                <x-core::icon name="ti ti-robot" class="text-warning me-2" style="width: 16px; height: 16px;" />
                                <small>{{ trans('libs/sitemap::sitemap.settings.benefit_automatic') }}</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                <x-core::icon name="ti ti-world" class="text-warning me-2" style="width: 16px; height: 16px;" />
                                <small>{{ trans('libs/sitemap::sitemap.settings.benefit_multiple') }}</small>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center">
                                <x-core::icon name="ti ti-shield-check" class="text-warning me-2" style="width: 16px; height: 16px;" />
                                <small>{{ trans('libs/sitemap::sitemap.settings.benefit_reliable') }}</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="alert alert-info border-0 mb-0">
                    <div class="d-flex align-items-start">
                        ...
                        <div>
                            <strong>{{ trans('libs/sitemap::sitemap.settings.about_google') }}</strong>
                            <div class="mt-1">{{ trans('libs/sitemap::sitemap.settings.google_note') }}</div>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function generateIndexNowKey() {
        handleKeyGeneration('{{ trans('libs/sitemap::sitemap.settings.generating') }}');
    }

    function regenerateIndexNowKey() {
        if (!confirm('{{ trans('libs/sitemap::sitemap.settings.regenerate_confirm') }}')) {
            return;
        }
        handleKeyGeneration('{{ trans('libs/sitemap::sitemap.settings.regenerating') }}');
    }
    ...
    function createKeyFile() {
        ...
        button.innerHTML = `<x-core::icon name="ti ti-loader" class="me-1 animate-spin" />` + '{{ trans('libs/sitemap::sitemap.settings.creating_key_file') }}';
        ...
        .catch(error => {
            ...
            alert('{{ trans('libs/sitemap::sitemap.settings.key_file_creation_error') }}');
    ...
    function handleKeyGeneration(loadingText) {
        ...
        .catch(error => {
            console.error('Error:', error);
            alert('{{ trans('libs/sitemap::sitemap.settings.generate_key_error') }}');
