...
namespace Dev\Sitemap\Services;
...
class IndexNowService
{
    ...
    {
        $this->enabled = setting('indexnow_enabled', config('libs.sitemap.config.indexnow_enabled', true));
        $this->endpoints = config('libs.sitemap.config.indexnow_endpoints', []);
