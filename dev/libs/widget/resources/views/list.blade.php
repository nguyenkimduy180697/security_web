    ...
    >
        <div class="page-header mb-4">
            <div class="row align-items-center">
                <div class="col">
                    <div class="page-pretitle">{{ trans('libs/widget::widget.name') }}</div>
                    <h2 class="page-title">{{ trans('libs/widget::widget.manage_widgets') }}</h2>
                </div>
            </div>
        </div>
                ...
                <x-core::card class="h-100">
                    <x-core::card.header>
                        <x-core::card.title class="d-flex align-items-center">
                            ...
                            {{ trans('libs/widget::widget.available') }}
                        </x-core::card.title>
                    </x-core::card.header>
                    <x-core::card.body>
                        <div
                ...
                <x-core::card>
                    <x-core::card.header>
                        <x-core::card.title class="d-flex align-items-center">
                            ...
                            {{ trans('libs/widget::widget.widget_areas') }}
                        </x-core::card.title>
                    </x-core::card.header>
                    <x-core::card.body>
