<div id="widget-cache-suggestion" class="alert alert-info alert-dismissible" style="margin: 20px 0;">
    <div class="d-flex">
        ...
        <div class="flex-fill">
            <h5 class="mb-1">{{ trans('libs/widget::widget.cache_suggestion.title') }}</h5>
            <p class="mb-1">
                {{ trans('libs/widget::widget.cache_suggestion.description') }}
                {{ trans('libs/widget::widget.cache_suggestion.benefits') }}
            </p>
            <div class="mt-2">
                <a href="{{ route('settings.cache') }}#widget-cache-settings" class="btn btn-info btn-sm">
                    <x-core::icon name="ti ti-settings" class="me-1" />
                    {{ trans('libs/widget::widget.cache_suggestion.enable_button') }}
                </a>
                <button type="button" class="btn btn-outline-secondary btn-sm ms-2 dismiss-widget-suggestion">
                    ...
                    {{ trans('libs/widget::widget.cache_suggestion.dismiss_button') }}
                </button>
            </div>
        </div>
    </div>
