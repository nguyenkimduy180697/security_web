...
use Dev\Widget\Widgets\ValueObjects\CoreSimpleMenuItem;
...
class CoreSimpleMenu extends AbstractWidget
{
    ...
    {
        parent::__construct([
            'name' => trans('libs/widget::widget.widget_menu'),
            'description' => trans('libs/widget::widget.widget_menu_description'),
            'items' => [],
        ]);
    ...
    public function adminConfig(): array
    {
        $fields = [
            [
                'type' => 'text',
                'label' => trans('libs/widget::widget.widget_menu_label'),
                'required' => true,
                'attributes' => [
                    'name' => 'label',
                    'value' => null,
            ...
            [
                'type' => 'text',
                'label' => trans('libs/widget::widget.widget_menu_url'),
                'required' => true,
                'attributes' => [
                    'name' => 'url',
                    'value' => null,
            ...
            [
                'type' => 'text',
                'label' => trans('libs/widget::widget.widget_menu_attributes'),
                'attributes' => [
                    'name' => 'attributes',
                    'value' => null,
                    'options' => [
            ...
            [
                'type' => 'onOff',
                'label' => trans('libs/widget::widget.widget_menu_is_open_new_tab'),
                'attributes' => [
