...
namespace Dev\Page\Http\Controllers\API;

use Dev\Api\Http\Controllers\BaseApiController;
use Dev\Page\Http\Resources\ListPageResource;
use Dev\Page\Http\Resources\PageResource;
