...
namespace Dev\LogViewer\Entities;

use Dev\LogViewer\Contracts\Utilities\Filesystem as FilesystemContract;
use Dev\LogViewer\Contracts\Utilities\Filesystem;
use Dev\LogViewer\Exceptions\LogNotFoundException;
...
class LogCollection extends Collection
{
    ...
    {
        $this->setFilesystem(app('dev::log-viewer.filesystem'));
