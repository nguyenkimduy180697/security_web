                                ...
                                @foreach($messages as $message)
                                    <div class="chat-item">
                                        <div class="row align-items-end">
                                            <div class="col-auto">
                                                <span class="avatar" style="background-image: url('{{ $message->sender?->avatar_url ?: AppMedia::getDefaultImage() }}')"></span>
                                            </div>
                                            <div class="col">
            ...
            <x-core::card>
                <div class="border-bottom p-3 mb-3">
                    <div class="d-flex align-items-center gap-2">
                        <span class="avatar avatar-sm rounded" style="background-image: url('{{ $ticket->sender?->avatar_url ?: AppMedia::getDefaultImage() }}')"></span>
                        <div>
