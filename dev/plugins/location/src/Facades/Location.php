...
namespace Dev\Location\Facades;

use Dev\Location\Location as BaseLocation;
use Illuminate\Support\Facades\Facade;

/**
 * @method static array getStates()
 * @method static array getCitiesByState(string|int|null $stateId)
 * @method static \Dev\Location\Models\City|\Illuminate\Database\Eloquent\Model|null getCityById(string|int|null $cityId)
