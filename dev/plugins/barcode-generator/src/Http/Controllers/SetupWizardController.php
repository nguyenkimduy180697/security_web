...
use Dev\BarcodeGenerator\Enums\PaperSizeEnum;
...
class SetupWizardController extends BaseController
{
    ...
    {
        $this->pageTitle(trans('plugins/barcode-generator::barcode-generator.setup_wizard.title'));

        Assets::addStylesDirectly('vendor/core/plugins/barcode-generator/css/barcode-generator.css')
            ->addScriptsDirectly('vendor/core/plugins/barcode-generator/js/setup-wizard.js');
        ...
        return view('plugins/barcode-generator::setup-wizard.index', [
    ...
    public function store(Request $request): BaseHttpResponse
    {
        ...
        return $this
            ...
            ->setMessage(trans('plugins/barcode-generator::barcode-generator.setup_wizard.step_completed'));
    }
    ...
    public function complete(): BaseHttpResponse
    {
        ...
        return $this
            ...
            ->setMessage(trans('plugins/barcode-generator::barcode-generator.setup_wizard.completed'));
    }
    ...
    public function skip(): BaseHttpResponse
    {
        ...
        return $this
            ->httpResponse()
            ->setData(['redirect_url' => route('barcode-generator.index')])
            ->setMessage(trans('plugins/barcode-generator::barcode-generator.setup_wizard.skipped'));
    }
    ...
    protected function createDefaultTemplate(Request $request): void
    {
        ...
        $templateName = $request->input('template_name', trans('plugins/barcode-generator::barcode-generator.setup_wizard_ui.default_template_value'));
    ...
    protected function createOfficeTemplate(string $name, string $paperSize, string $barcodeType): BarcodeTemplate
    {
        return BarcodeTemplate::create([
            'name' => $name,
            'description' => trans('plugins/barcode-generator::barcode-generator.setup_wizard.auto_generated_description'),
    ...
    protected function createThermalTemplate(string $name, string $paperSize, string $barcodeType): BarcodeTemplate
    {
        ...
        return BarcodeTemplate::create([
            'name' => $name,
            'description' => trans('plugins/barcode-generator::barcode-generator.setup_wizard.auto_generated_thermal_description'),
            'paper_size' => $paperSize,
            'barcode_type' => $barcodeType,
