    ...
    @if (is_plugin_active('blog'))
        <x-core::stat-widget class="mb-3 row-cols-1 row-cols-sm-2 row-cols-md-3">
            <x-core::stat-widget.item
                ...
                :value="$user->posts()->where('status', Dev\Base\Enums\BaseStatusEnum::PUBLISHED)->count()"
            ...
            <x-core::stat-widget.item
                ...
                :value="$user->posts()->where('status', Dev\Base\Enums\BaseStatusEnum::PENDING)->count()"
            ...
            <x-core::stat-widget.item
                ...
                :value="$user->posts()->where('status', Dev\Base\Enums\BaseStatusEnum::DRAFT)->count()"
                icon="ti ti-notes"
                color="danger"
            />
        </x-core::stat-widget>
