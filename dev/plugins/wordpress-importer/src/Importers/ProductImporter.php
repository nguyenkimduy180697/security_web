...
namespace Dev\WordpressImporter\Importers;
...
use Dev\Ecommerce\Enums\ProductTypeEnum;
use Dev\Ecommerce\Enums\StockStatusEnum;
use Dev\Ecommerce\Models\Product;
use Dev\Ecommerce\Models\ProductAttribute;
use Dev\Ecommerce\Models\ProductAttributeSet;
use Dev\Ecommerce\Models\ProductCategory;
use Dev\Ecommerce\Models\ProductVariation;
use Dev\Ecommerce\Services\Products\StoreProductService;
use Dev\Ecommerce\Services\StoreProductTagService;
...
class ProductImporter extends Importer implements WithMapping
{
    ...
    protected function saveDigitalProductFiles(array $productFiles): void
    {
        ...
        $serverMaxUploadFileSize = AppMedia::getServerConfigMaxUploadFileSize();
    ...
    {
        $mimeType = AppMedia::getMimeType($path);
