...
if (! function_exists('get_field')) {
     ...
     */
    function get_field(BaseModel $data, ?string $key = null, string|array|null $default = null): string|array|null
    {
...
if (! function_exists('get_sub_field')) {
    function get_sub_field(array $parentField, string $key, string|array|null $default = null): string|array|null
    {
