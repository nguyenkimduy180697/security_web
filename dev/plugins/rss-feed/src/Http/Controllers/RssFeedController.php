...
namespace Dev\RssFeed\Http\Controllers;

use Dev\Base\Facades\BaseHelper;
use Dev\Blog\Models\Post;
use Dev\JobBoard\Models\Job;
use Dev\Media\Facades\AppMedia;
use Dev\RealEstate\Repositories\Interfaces\ProjectInterface;
use Dev\RealEstate\Repositories\Interfaces\PropertyInterface;
use Dev\RssFeed\Facades\RssFeed;
        ...
        switch ($name) {
            case 'posts':
                ...
                foreach ($data as $item) {
                    ...
                    $imageURL = AppMedia::getImageUrl($item->image, null, false, AppMedia::getDefaultImage());
                    ...
                    $feedItem = FeedItem::create()
                        ...
                        ->enclosure($imageURL)
                        ->enclosureType(AppMedia::getMimeType(AppMedia::getRealPath($item->image ?: AppMedia::getDefaultImage())))
