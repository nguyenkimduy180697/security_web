...
namespace Dev\VietnamBankQr\Providers;
...
use Dev\Ecommerce\Models\Currency;
use Dev\Ecommerce\Models\Order;
use Dev\Payment\Enums\PaymentMethodEnum;
use Dev\Payment\Forms\BankTransferPaymentMethodForm;
use Dev\VietnamBankQr\VietQR;
...
class VietnamBankQrServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        $this
            ->setNamespace('plugins/vietnam-bank-qr')
            ->loadAndPublishViews();
        ...
        add_filter('ecommerce_thank_you_customer_info', function (string|null $html, Collection|Order $orders) {
            ...
            $html .= view(
                'plugins/vietnam-bank-qr::bank-info',
                [
