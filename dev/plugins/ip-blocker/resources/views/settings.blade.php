        ...
        <x-core-setting::section>
            ...
            @if($secretKey)
                ...
                <x-core-setting::form-group class="mt-3">
                    ...
                    <label>
                        <input type="checkbox" class="check-all" data-set=".available-countries" @if(empty($countriesCode) || empty(array_diff(array_keys(\Dev\Base\Supports\Helper::countries()), $countriesCode))) checked @endif>
                        {{ trans('plugins/ip-blocker::ip-blocker.all_countries') }}
                    </label>
                    <div class="form-group form-group-no-margin">
                        <div class="multi-choices-widget list-item-checkbox">
                            <ul>
                                @foreach (\Dev\Base\Supports\Helper::countries() as $key => $item)
                                    <li>
                                        <input
                                                type="checkbox"
