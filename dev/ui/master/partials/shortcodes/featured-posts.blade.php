                        ...
                        <div class="post-group__left">
                            <article class="post post__inside post__inside--feature">
                                <div class="post__thumbnail">
                                    {{ AppMedia::image($post->image, $post->name, 'featured', attributes: ['loading' => 'eager'], lazy: false) }}
                                    <a
                                        class="post__overlay"
                                        href="{{ $post->url }}"
                                        title="{{ $post->name }}"
                        ...
                        @else
                            <div class="post-group__item">
                                <article class="post post__inside post__inside--feature post__inside--feature-small">
                                    <div class="post__thumbnail">
                                        {{ AppMedia::image($post->image, $post->name, 'medium', attributes: ['loading' => 'eager'], lazy: false) }}
                                        <a
                                            class="post__overlay"
                                            href="{{ $post->url }}"
                                            title="{{ $post->name }}"
